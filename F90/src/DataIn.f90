...
!------------------------------------------------------------------
    ...
    do ibody = 1, nb_body
       ...
       tie = tie + cie
       print *, ' mass:', cmass
       print *, '  kinetic energy:', cke
       print *, ' internal energy:', cie
    ...
    print *, 'total internal energy:', tie
...
!------------------------------------------------------------------
    ...
    case(1)
       ...
       normbody = GetInt()    
       print *, 'Notice: Bardenhagens contact method &
                       is used with USF '
       !write(iomsg,"(a)") 'Notice: Bardenhagens contact method &
       !                    is used with USF'
       print *, 'frictional factor = ',fricfa
    ...
    case(2)            
       ...
       ! the computational method of contact normal
       normbody = GetInt()    
       print *, 'Notice: another contact method &
                       is used with USF '
